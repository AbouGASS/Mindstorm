...
public class Rotationtest {
	...
	public static void main(String[] args) {
		...
		displayFull("MA power ..."+Motor.A.getSpeed() );
		displayFull("MB power ..."+Motor.B.getSpeed() );
		Button.waitForAnyPress();
		...
		do{
			...
			if(captureCouleur()== 1){
				...
				if(rotation_side==1){
					...
					pilot.rotate(angle*rotation_side,false);
					rotation_side=-1;
					if(captureCouleur()== 1){
							travel();
							angle=10;
						...
						pilot.rotate(2*angle*rotation_side,false);
						rotation_side=1;
						if(captureCouleur()== 1){
							travel();
							angle=10;
						...
						//else{
							//rotation_side=-1;
							//pilot.rotate(2.5*angle*rotation_side,false);
							//rotation_side=1;
						//}
						}
					}
